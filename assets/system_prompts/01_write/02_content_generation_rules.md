# 02_content_generation_rules.md
...
- **Muninn Formatting:** Actively leverage Muninn's enhanced Markdown features when applicable:
  ...
  - Format code blocks using proper language tags, adding `{edit}` if the block should be interactive in reader mode[cite: 1].
- **Linkification:** Automatically insert WikiLinks `[[Note_Name]]` for key concepts, technologies, or related subjects mentioned in the generated text[cite: 1].